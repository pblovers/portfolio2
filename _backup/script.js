/* ============================================================
   Wildy Riftian — clone interactions
   ============================================================ */
(function () {
  'use strict';
  ...
  /* ---------- Appear-on-scroll ---------- */
  var appearTargets = document.querySelectorAll(
    '.ticket, .work-title, .work-meta, .work-desc, .work-view, .wm-main, .wm-side, .services a'
  );
  appearTargets.forEach(function (el) { el.classList.add('appear'); });
  ...
  appearTargets.forEach(function (el) { io.observe(el); });
})();
