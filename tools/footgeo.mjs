...
const PAGES = {
  ...
  branding: ['https://www.wildyriftian.com/works-branding','works/works-branding.html'],
  detail:   ['https://www.wildyriftian.com/works/overbloom','project/project-aquaplanet.html'],
  flat:     ['https://www.wildyriftian.com/works/flat-earther','works/work-flat-earther.html'],
  pw:       ['https://www.wildyriftian.com/works-photoworks','works/works-photoworks.html'],
};
